...
<div class="swiper-slide h-auto mb-8">

    <div class="h-full flex flex-col rounded-2xl shadow-md hover:shadow-xl 
                transition duration-300 overflow-hidden group bg-white">

        <!-- IMAGE -->
        <a href="{{ route('frontend.product.productdetails', $product->id) }}"
           class="block h-52 bg-gray-100 overflow-hidden">
        ...
        <div class="p-4 flex flex-col flex-1">
            ...
            <div class="mt-3 flex items-center justify-between min-h-[40px]">
